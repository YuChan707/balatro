...
prompt = "Parsing the TXT, identify topics and create json representatives of flashcards for the topic. If the “question” is returning more than 15 words, DO NOT USE THIS, summarize further. Use the above templates as a base for creating flashcards on the TXT. return JSON code in template above."
full_prompt = "TXT: " + text + "\n" + "TEMPLATE: " + cot + "\n" + "ACTION: " + prompt
